        ...
        <nav>
            <div className="navigation">
                ...
                <ul>
                    ...
                    <li><Link to={{pathname:"https://drive.google.com/file/d/1lW3Xv5QVL4AC72v2_IhrGvtb42RR76ak/view?usp=sharing"}}  target='_blank' ><span className="resume">Resume</span></Link></li>
